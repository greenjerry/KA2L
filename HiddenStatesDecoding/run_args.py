...
DATASET_NAMES = [
    ...
    "/users/shenrujia/yinhx/dataset/vec2text_custom_one-million-instructions",
    "/users/shenrujia/yinhx/dataset/vec2text_210k_combined_shuffled",
    "/users/shenrujia/yinhx/dataset/one-million-instructions",
    "/users/shenrujia/yinhx/dataset/vec2text_25w_combined_5wtrivia",
    "/users/shenrujia/yinhx/dataset/vec2text_25w_combined_5wnqopen",
    "/users/shenrujia/yinhx/dataset/vec2text_25w_combined_5wmedmcqa",
]
